          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            {!user.isLoggedIn && (
              <button
                ...
                className="px-6 py-3.5 rounded-xl bg-white hover:bg-slate-100 text-slate-950 font-bold text-sm tracking-wide transition-all shadow-lg flex items-center space-x-2.5 active:scale-95"
                id="hero-sign-in-btn"
              >
